...
export default defineConfig({
	...
	themeConfig: {
		...
		socialLinks: [{ icon: 'github', link: 'https://github.com/zfleaves/ts-study' }],

		footer: {
			copyright:
				'Copyright © 2023-present <a href="https://github.com/zfleaves/ts-study">zfleaves</a>, All Rights Reserved',
		},
	},
});
